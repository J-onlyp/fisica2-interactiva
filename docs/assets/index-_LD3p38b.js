...
}`;function FE(o,t,i){let s=new Hh;const l=new Ot,c=new Ot,d=new tn,h=new rS({depthPacking:vb}),m=new oS,p={},x=i.maxTextureSize,g={[Ja]:Xn,[Xn]:Ja,[ca]:ca},y=new pa({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ot},radius:{value:4}},vertexShader:PE,fragmentShader:IE}),b=y.clone();b.defines.HORIZONTAL_PASS=1;const M=new xi;M.setAttribute("position",new Li(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const R=new Ln(M,y),S=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Bg;let _=this.type;this.render=function(O,H,$){if(S.enabled===!1||S.autoUpdate===!1&&S.needsUpdate===!1||O.length===0)return;const D=o.getRenderTarget(),T=o.getActiveCubeFace(),j=o.getActiveMipmapLevel(),Y=o.state;Y.setBlending(da),Y.buffers.depth.getReversed()===!0?Y.buffers.color.setClear(0,0,0,0):Y.buffers.color.setClear(1,1,1,1),Y.buffers.depth.setTest(!0),Y.setScissorTest(!1);const Q=_!==la&&this.type===la,re=_===la&&this.type!==la;for(let ae=0,I=O.length;ae<I;ae++){const G=O[ae],U=G.shadow;if(U===void 0){ut("WebGLShadowMap:",G,"has no shadow.");continue}if(U.autoUpdate===!1&&U.needsUpdate===!1)continue;l.copy(U.mapSize);const V=U.getFrameExtents();if(l.multiply(V),c.copy(U.mapSize),(l.x>x||l.y>x)&&(l.x>x&&(c.x=Math.floor(x/V.x),l.x=c.x*V.x,U.mapSize.x=c.x),l.y>x&&(c.y=Math.floor(x/V.y),l.y=c.y*V.y,U.mapSize.y=c.y)),U.map===null||Q===!0||re===!0){const N=this.type!==la?{minFilter:ai,magFilter:ai}:{};U.map!==null&&U.map.dispose(),U.map=new Cs(l.x,l.y,N),U.map.texture.name=G.name+".shadowMap",U.camera.updateProjectionMatrix()}o.setRenderTarget(U.map),o.clear();const J=U.getViewportCount();for(let N=0;N<J;N++){const X=U.getViewport(N);d.set(c.x*X.x,c.y*X.y,c.x*X.z,c.y*X.w),Y.viewport(d),U.updateMatrices(G,N),s=U.getFrustum(),P(H,$,U.camera,G,this.type)}U.isPointLightShadow!==!0&&this.type===la&&z(U,$),U.needsUpdate=!1}_=this.type,S.needsUpdate=!1,o.setRenderTarget(D,T,j)};function z(O,H){const $=t.update(R);y.defines.VSM_SAMPLES!==O.blurSamples&&(y.defines.VSM_SAMPLES=O.blurSamples,b.defines.VSM_SAMPLES=O.blurSamples,y.needsUpdate=!0,b.needsUpdate=!0),O.mapPass===null&&(O.mapPass=new Cs(l.x,l.y)),y.uniforms.shadow_pass.value=O.map.texture,y.uniforms.resolution.value=O.mapSize,y.uniforms.radius.value=O.radius,o.setRenderTarget(O.mapPass),o.clear(),o.renderBufferDirect(H,null,$,y,R,null),b.uniforms.shadow_pass.value=O.mapPass.texture,b.uniforms.resolution.value=O.mapSize,b.uniforms.radius.value=O.radius,o.setRenderTarget(O.map),o.clear(),o.renderBufferDirect(H,null,$,b,R,null)}function L(O,H,$,D){let T=null;const j=$.isPointLight===!0?O.customDistanceMaterial:O.customDepthMaterial;if(j!==void 0)T=j;else if(T=$.isPointLight===!0?m:h,o.localClippingEnabled&&H.clipShadows===!0&&Array.isArray(H.clippingPlanes)&&H.clippingPlanes.length!==0||H.displacementMap&&H.displacementScale!==0||H.alphaMap&&H.alphaTest>0||H.map&&H.alphaTest>0||H.alphaToCoverage===!0){const Y=T.uuid,Q=H.uuid;let re=p[Y];re===void 0&&(re={},p[Y]=re);let ae=re[Q];ae===void 0&&(ae=T.clone(),re[Q]=ae,H.addEventListener("dispose",B)),T=ae}if(T.visible=H.visible,T.wireframe=H.wireframe,D===la?T.side=H.shadowSide!==null?H.shadowSide:H.side:T.side=H.shadowSide!==null?H.shadowSide:g[H.side],T.alphaMap=H.alphaMap,T.alphaTest=H.alphaToCoverage===!0?.5:H.alphaTest,T.map=H.map,T.clipShadows=H.clipShadows,T.clippingPlanes=H.clippingPlanes,T.clipIntersection=H.clipIntersection,T.displacementMap=H.displacementMap,T.displacementScale=H.displacementScale,T.displacementBias=H.displacementBias,T.wireframeLinewidth=H.wireframeLinewidth,T.linewidth=H.linewidth,$.isPointLight===!0&&T.isMeshDistanceMaterial===!0){const Y=o.properties.get(T);Y.light=$}return T}function P(O,H,$,D,T){if(O.visible===!1)return;if(O.layers.test(H.layers)&&(O.isMesh||O.isLine||O.isPoints)&&(O.castShadow||O.receiveShadow&&T===la)&&(!O.frustumCulled||s.intersectsObject(O))){O.modelViewMatrix.multiplyMatrices($.matrixWorldInverse,O.matrixWorld);const Q=t.update(O),re=O.material;if(Array.isArray(re)){const ae=Q.groups;for(let I=0,G=ae.length;I<G;I++){const U=ae[I],V=re[U.materialIndex];if(V&&V.visible){const J=L(O,V,D,T);O.onBeforeShadow(o,O,H,$,Q,J,U),o.renderBufferDirect($,null,Q,J,O,U),O.onAfterShadow(o,O,H,$,Q,J,U)}}}else if(re.visible){const ae=L(O,re,D,T);O.onBeforeShadow(o,O,H,$,Q,ae,null),o.renderBufferDirect($,null,Q,ae,O,null),O.onAfterShadow(o,O,H,$,Q,ae,null)}}const Y=O.children;for(let Q=0,re=Y.length;Q<re;Q++)P(Y[Q],H,$,D,T)}function B(O){O.target.removeEventListener("dispose",B);for(const $ in p){const D=p[$],T=O.target.uuid;T in D&&(D[T].dispose(),delete D[T])}}}const BE={[Gd]:Vd,[kd]:qd,[jd]:Wd,[Mr]:Xd,[Vd]:Gd,[qd]:kd,[Wd]:jd,[Xd]:Mr};function HE(o,t){function i(){let W=!1;const Le=new tn;let De=null;const Ne=new tn(0,0,0,0);return{setMask:function(Re){De!==Re&&!W&&(o.colorMask(Re,Re,Re,Re),De=Re)},setLocked:function(Re){W=Re},setClear:function(Re,Se,Be,rt,Ht){Ht===!0&&(Re*=rt,Se*=rt,Be*=rt),Le.set(Re,Se,Be,rt),Ne.equals(Le)===!1&&(o.clearColor(Re,Se,Be,rt),Ne.copy(Le))},reset:function(){W=!1,De=null,Ne.set(-1,0,0,0)}}}function s(){let W=!1,Le=!1,De=null,Ne=null,Re=null;return{setReversed:function(Se){if(Le!==Se){const Be=t.get("EXT_clip_control");Se?Be.clipControlEXT(Be.LOWER_LEFT_EXT,Be.ZERO_TO_ONE_EXT):Be.clipControlEXT(Be.LOWER_LEFT_EXT,Be.NEGATIVE_ONE_TO_ONE_EXT),Le=Se;const rt=Re;Re=null,this.setClear(rt)}},getReversed:function(){return Le},setTest:function(Se){Se?ie(o.DEPTH_TEST):_e(o.DEPTH_TEST)},setMask:function(Se){De!==Se&&!W&&(o.depthMask(Se),De=Se)},setFunc:function(Se){if(Le&&(Se=BE[Se]),Ne!==Se){switch(Se){case Gd:o.depthFunc(o.NEVER);break;case Vd:o.depthFunc(o.ALWAYS);break;case kd:o.depthFunc(o.LESS);break;case Mr:o.depthFunc(o.LEQUAL);break;case jd:o.depthFunc(o.EQUAL);break;case Xd:o.depthFunc(o.GEQUAL);break;case qd:o.depthFunc(o.GREATER);break;case Wd:o.depthFunc(o.NOTEQUAL);break;default:o.depthFunc(o.LEQUAL)}Ne=Se}},setLocked:function(Se){W=Se},setClear:function(Se){Re!==Se&&(Le&&(Se=1-Se),o.clearDepth(Se),Re=Se)},reset:function(){W=!1,De=null,Ne=null,Re=null,Le=!1}}}function l(){let W=!1,Le=null,De=null,Ne=null,Re=null,Se=null,Be=null,rt=null,Ht=null;return{setTest:function(wt){W||(wt?ie(o.STENCIL_TEST):_e(o.STENCIL_TEST))},setMask:function(wt){Le!==wt&&!W&&(o.stencilMask(wt),Le=wt)},setFunc:function(wt,wn,qn){(De!==wt||Ne!==wn||Re!==qn)&&(o.stencilFunc(wt,wn,qn),De=wt,Ne=wn,Re=qn)},setOp:function(wt,wn,qn){(Se!==wt||Be!==wn||rt!==qn)&&(o.stencilOp(wt,wn,qn),Se=wt,Be=wn,rt=qn)},setLocked:function(wt){W=wt},setClear:function(wt){Ht!==wt&&(o.clearStencil(wt),Ht=wt)},reset:function(){W=!1,Le=null,De=null,Ne=null,Re=null,Se=null,Be=null,rt=null,Ht=null}}}const c=new i,d=new s,h=new l,m=new WeakMap,p=new WeakMap;let x={},g={},y=new WeakMap,b=[],M=null,R=!1,S=null,_=null,z=null,L=null,P=null,B=null,O=null,H=new Rt(0,0,0),$=0,D=!1,T=null,j=null,Y=null,Q=null,re=null;const ae=o.getParameter(o.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let I=!1,G=0;const U=o.getParameter(o.VERSION);U.indexOf("WebGL")!==-1?(G=parseFloat(/^WebGL (\d)/.exec(U)[1]),I=G>=1):U.indexOf("OpenGL ES")!==-1&&(G=parseFloat(/^OpenGL ES (\d)/.exec(U)[1]),I=G>=2);let V=null,J={};const N=o.getParameter(o.SCISSOR_BOX),X=o.getParameter(o.VIEWPORT),se=new tn().fromArray(N),pe=new tn().fromArray(X);function Me(W,Le,De,Ne){const Re=new Uint8Array(4),Se=o.createTexture();o.bindTexture(W,Se),o.texParameteri(W,o.TEXTURE_MIN_FILTER,o.NEAREST),o.texParameteri(W,o.TEXTURE_MAG_FILTER,o.NEAREST);for(let Be=0;Be<De;Be++)W===o.TEXTURE_3D||W===o.TEXTURE_2D_ARRAY?o.texImage3D(Le,0,o.RGBA,1,1,Ne,0,o.RGBA,o.UNSIGNED_BYTE,Re):o.texImage2D(Le+Be,0,o.RGBA,1,1,0,o.RGBA,o.UNSIGNED_BYTE,Re);return Se}const K={};K[o.TEXTURE_2D]=Me(o.TEXTURE_2D,o.TEXTURE_2D,1),K[o.TEXTURE_CUBE_MAP]=Me(o.TEXTURE_CUBE_MAP,o.TEXTURE_CUBE_MAP_POSITIVE_X,6),K[o.TEXTURE_2D_ARRAY]=Me(o.TEXTURE_2D_ARRAY,o.TEXTURE_2D_ARRAY,1,1),K[o.TEXTURE_3D]=Me(o.TEXTURE_3D,o.TEXTURE_3D,1,1),c.setClear(0,0,0,1),d.setClear(1),h.setClear(0),ie(o.DEPTH_TEST),d.setFunc(Mr),mt(!1),gt(Ux),ie(o.CULL_FACE),ct(da);function ie(W){x[W]!==!0&&(o.enable(W),x[W]=!0)}function _e(W){x[W]!==!1&&(o.disable(W),x[W]=!1)}function Ee(W,Le){return g[W]!==Le?(o.bindFramebuffer(W,Le),g[W]=Le,W===o.DRAW_FRAMEBUFFER&&(g[o.FRAMEBUFFER]=Le),W===o.FRAMEBUFFER&&(g[o.DRAW_FRAMEBUFFER]=Le),!0):!1}function Ue(W,Le){let De=b,Ne=!1;if(W){De=y.get(Le),De===void 0&&(De=[],y.set(Le,De));const Re=W.textures;if(De.length!==Re.length||De[0]!==o.COLOR_ATTACHMENT0){for(let Se=0,Be=Re.length;Se<Be;Se++)De[Se]=o.COLOR_ATTACHMENT0+Se;De.length=Re.length,Ne=!0}}else De[0]!==o.BACK&&(De[0]=o.BACK,Ne=!0);Ne&&o.drawBuffers(De)}function $e(W){return M!==W?(o.useProgram(W),M=W,!0):!1}const yt={[Es]:o.FUNC_ADD,[Xy]:o.FUNC_SUBTRACT,[qy]:o.FUNC_REVERSE_SUBTRACT};yt[Wy]=o.MIN,yt[Yy]=o.MAX;const Ke={[Zy]:o.ZERO,[Ky]:o.ONE,[Qy]:o.SRC_COLOR,[Bd]:o.SRC_ALPHA,[ib]:o.SRC_ALPHA_SATURATE,[tb]:o.DST_COLOR,[$y]:o.DST_ALPHA,[Jy]:o.ONE_MINUS_SRC_COLOR,[Hd]:o.ONE_MINUS_SRC_ALPHA,[nb]:o.ONE_MINUS_DST_COLOR,[eb]:o.ONE_MINUS_DST_ALPHA,[ab]:o.CONSTANT_COLOR,[sb]:o.ONE_MINUS_CONSTANT_COLOR,[rb]:o.CONSTANT_ALPHA,[ob]:o.ONE_MINUS_CONSTANT_ALPHA};function ct(W,Le,De,Ne,Re,Se,Be,rt,Ht,wt){if(W===da){R===!0&&(_e(o.BLEND),R=!1);return}if(R===!1&&(ie(o.BLEND),R=!0),W!==jy){if(W!==S||wt!==D){if((_!==Es||P!==Es)&&(o.blendEquation(o.FUNC_ADD),_=Es,P=Es),wt)switch(W){case br:o.blendFuncSeparate(o.ONE,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case Lx:o.blendFunc(o.ONE,o.ONE);break;case Ox:o.blendFuncSeparate(o.ZERO,o.ONE_MINUS_SRC_COLOR,o.ZERO,o.ONE);break;case zx:o.blendFuncSeparate(o.DST_COLOR,o.ONE_MINUS_SRC_ALPHA,o.ZERO,o.ONE);break;default:rn("WebGLState: Invalid blending: ",W);break}else switch(W){case br:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case Lx:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE,o.ONE,o.ONE);break;case Ox:rn("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case zx:rn("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:rn("WebGLState: Invalid blending: ",W);break}z=null,L=null,B=null,O=null,H.set(0,0,0),$=0,S=W,D=wt}return}Re=Re||Le,Se=Se||De,Be=Be||Ne,(Le!==_||Re!==P)&&(o.blendEquationSeparate(yt[Le],yt[Re]),_=Le,P=Re),(De!==z||Ne!==L||Se!==B||Be!==O)&&(o.blendFuncSeparate(Ke[De],Ke[Ne],Ke[Se],Ke[Be]),z=De,L=Ne,B=Se,O=Be),(rt.equals(H)===!1||Ht!==$)&&(o.blendColor(rt.r,rt.g,rt.b,Ht),H.copy(rt),$=Ht),S=W,D=!1}function q(W,Le){W.side===ca?_e(o.CULL_FACE):ie(o.CULL_FACE);let De=W.side===Xn;Le&&(De=!De),mt(De),W.blending===br&&W.transparent===!1?ct(da):ct(W.blending,W.blendEquation,W.blendSrc,W.blendDst,W.blendEquationAlpha,W.blendSrcAlpha,W.blendDstAlpha,W.blendColor,W.blendAlpha,W.premultipliedAlpha),d.setFunc(W.depthFunc),d.setTest(W.depthTest),d.setMask(W.depthWrite),c.setMask(W.colorWrite);const Ne=W.stencilWrite;h.setTest(Ne),Ne&&(h.setMask(W.stencilWriteMask),h.setFunc(W.stencilFunc,W.stencilRef,W.stencilFuncMask),h.setOp(W.stencilFail,W.stencilZFail,W.stencilZPass)),Ve(W.polygonOffset,W.polygonOffsetFactor,W.polygonOffsetUnits),W.alphaToCoverage===!0?ie(o.SAMPLE_ALPHA_TO_COVERAGE):_e(o.SAMPLE_ALPHA_TO_COVERAGE)}function mt(W){T!==W&&(W?o.frontFace(o.CW):o.frontFace(o.CCW),T=W)}function gt(W){W!==Gy?(ie(o.CULL_FACE),W!==j&&(W===Ux?o.cullFace(o.BACK):W===Vy?o.cullFace(o.FRONT):o.cullFace(o.FRONT_AND_BACK))):_e(o.CULL_FACE),j=W}function It(W){W!==Y&&(I&&o.lineWidth(W),Y=W)}function Ve(W,Le,De){W?(ie(o.POLYGON_OFFSET_FILL),(Q!==Le||re!==De)&&(o.polygonOffset(Le,De),Q=Le,re=De)):_e(o.POLYGON_OFFSET_FILL)}function Xt(W){W?ie(o.SCISSOR_TEST):_e(o.SCISSOR_TEST)}function Ze(W){W===void 0&&(W=o.TEXTURE0+ae-1),V!==W&&(o.activeTexture(W),V=W)}function ot(W,Le,De){De===void 0&&(V===null?De=o.TEXTURE0+ae-1:De=V);let Ne=J[De];Ne===void 0&&(Ne={type:void 0,texture:void 0},J[De]=Ne),(Ne.type!==W||Ne.texture!==Le)&&(V!==De&&(o.activeTexture(De),V=De),o.bindTexture(W,Le||K[W]),Ne.type=W,Ne.texture=Le)}function F(){const W=J[V];W!==void 0&&W.type!==void 0&&(o.bindTexture(W.type,null),W.type=void 0,W.texture=void 0)}function A(){try{o.compressedTexImage2D(...arguments)}catch(W){W("WebGLState:",W)}}function le(){try{o.compressedTexImage3D(...arguments)}catch(W){W("WebGLState:",W)}}function ye(){try{o.texSubImage2D(...arguments)}catch(W){W("WebGLState:",W)}}function Te(){try{o.texSubImage3D(...arguments)}catch(W){W("WebGLState:",W)}}function xe(){try{o.compressedTexSubImage2D(...arguments)}catch(W){W("WebGLState:",W)}}function qe(){try{o.compressedTexSubImage3D(...arguments)}catch(W){W("WebGLState:",W)}}function ze(){try{o.texStorage2D(...arguments)}catch(W){W("WebGLState:",W)}}function et(){try{o.texStorage3D(...arguments)}catch(W){W("WebGLState:",W)}}function Xe(){try{o.texImage2D(...arguments)}catch(W){W("WebGLState:",W)}}function Ae(){try{o.texImage3D(...arguments)}catch(W){W("WebGLState:",W)}}function Ce(W){se.equals(W)===!1&&(o.scissor(W.x,W.y,W.z,W.w),se.copy(W))}function We(W){pe.equals(W)===!1&&(o.viewport(W.x,W.y,W.z,W.w),pe.copy(W))}function ke(W,Le){let De=p.get(Le);De===void 0&&(De=new WeakMap,p.set(Le,De));let Ne=De.get(W);Ne===void 0&&(Ne=o.getUniformBlockIndex(Le,W.name),De.set(W,Ne))}function Ie(W,Le){const Ne=p.get(Le).get(W);m.get(Le)!==Ne&&(o.uniformBlockBinding(Le,Ne,W.__bindingPointIndex),m.set(Le,Ne))}function st(){o.disable(o.BLEND),o.disable(o.CULL_FACE),o.disable(o.DEPTH_TEST),o.disable(o.POLYGON_OFFSET_FILL),o.disable(o.SCISSOR_TEST),o.disable(o.STENCIL_TEST),o.disable(o.SAMPLE_ALPHA_TO_COVERAGE),o.blendEquation(o.FUNC_ADD),o.blendFunc(o.ONE,o.ZERO),o.blendFuncSeparate(o.ONE,o.ZERO,o.ONE,o.ZERO),o.blendColor(0,0,0,0),o.colorMask(!0,!0,!0,!0),o.clearColor(0,0,0,0),o.depthMask(!0),o.depthFunc(o.LESS),d.setReversed(!1),o.clearDepth(1),o.stencilMask(4294967295),o.stencilFunc(o.ALWAYS,0,4294967295),o.stencilOp(o.KEEP,o.KEEP,o.KEEP),o.clearStencil(0),o.cullFace(o.BACK),o.frontFace(o.CCW),o.polygonOffset(0,0),o.activeTexture(o.TEXTURE0),o.bindFramebuffer(o.FRAMEBUFFER,null),o.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),o.bindFramebuffer(o.READ_FRAMEBUFFER,null),o.useProgram(null),o.lineWidth(1),o.scissor(0,0,o.canvas.width,o.canvas.height),o.viewport(0,0,o.canvas.width,o.canvas.height),x={},V=null,J={},g={},y=new WeakMap,b=[],M=null,R=!1,S=null,_=null,z=null,L=null,P=null,B=null,O=null,H=new Rt(0,0,0),$=0,D=!1,T=null,j=null,Y=null,Q=null,re=null,se.set(0,0,o.canvas.width,o.canvas.height),pe.set(0,0,o.canvas.width,o.canvas.height),c.reset(),d.reset(),h.reset()}return{buffers:{color:c,depth:d,stencil:h},enable:ie,disable:_e,bindFramebuffer:Ee,drawBuffers:Ue,useProgram:$e,setBlending:ct,setMaterial:q,setFlipSided:mt,setCullFace:gt,setLineWidth:It,setPolygonOffset:Ve,setScissorTest:Xt,activeTexture:Ze,bindTexture:ot,unbindTexture:F,compressedTexImage2D:A,compressedTexImage3D:le,texImage2D:Xe,texImage3D:Ae,updateUBOMapping:ke,uniformBlockBinding:Ie,texStorage2D:ze,texStorage3D:et,texSubImage2D:ye,texSubImage3D:Te,compressedTexSubImage2D:xe,compressedTexSubImage3D:qe,scissor:Ce,viewport:We,reset:st}}function GE(o,t,i,s,l,c,d){const h=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new Ot,x=new WeakMap;let g;const y=new WeakMap;let b=!1;try{b=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function M(F,A){return b?new OffscreenCanvas(F,A):Oc("canvas")}function R(F,A,le){let ye=1;const Te=ot(F);if((Te.width>le||Te.height>le)&&(ye=le/Math.max(Te.width,Te.height)),ye<1)if(typeof HTMLImageElement<"u"&&F instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&F instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&F instanceof ImageBitmap||typeof VideoFrame<"u"&&F instanceof VideoFrame){const xe=Math.floor(ye*Te.width),qe=Math.floor(ye*Te.height);g===void 0&&(g=M(xe,qe));const ze=A?M(xe,qe):g;return ze.width=xe,ze.height=qe,ze.getContext("2d").drawImage(F,0,0,xe,qe),ut("WebGLRenderer: Texture has been resized from ("+Te.width+"x"+Te.height+") to ("+xe+"x"+qe+")."),ze}else return"data"in F&&ut("WebGLRenderer: Image in DataTexture is too big ("+Te.width+"x"+Te.height+")."),F;return F}function S(F){return F.generateMipmaps}function _(F){o.generateMipmap(F)}function z(F){return F.isWebGLCubeRenderTarget?o.TEXTURE_CUBE_MAP:F.isWebGL3DRenderTarget?o.TEXTURE_3D:F.isWebGLArrayRenderTarget||F.isCompressedArrayTexture?o.TEXTURE_2D_ARRAY:o.TEXTURE_2D}function L(F,A,le,ye,Te=!1){if(F!==null){if(o[F]!==void 0)return o[F];ut("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+F+"'")}let xe=A;if(A===o.RED&&(le===o.FLOAT&&(xe=o.R32F),le===o.HALF_FLOAT&&(xe=o.R16F),le===o.UNSIGNED_BYTE&&(xe=o.R8)),A===o.RED_INTEGER&&(le===o.UNSIGNED_BYTE&&(xe=o.R8UI),le===o.UNSIGNED_SHORT&&(xe=o.R16UI),le===o.UNSIGNED_INT&&(xe=o.R32UI),le===o.BYTE&&(xe=o.R8I),le===o.SHORT&&(xe=o.R16I),le===o.INT&&(xe=o.R32I)),A===o.RG&&(le===o.FLOAT&&(xe=o.RG32F),le===o.HALF_FLOAT&&(xe=o.RG16F),le===o.UNSIGNED_BYTE&&(xe=o.RG8)),A===o.RG_INTEGER&&(le===o.UNSIGNED_BYTE&&(xe=o.RG8UI),le===o.UNSIGNED_SHORT&&(xe=o.RG16UI),le===o.UNSIGNED_INT&&(xe=o.RG32UI),le===o.BYTE&&(xe=o.RG8I),le===o.SHORT&&(xe=o.RG16I),le===o.INT&&(xe=o.RG32I)),A===o.RGB_INTEGER&&(le===o.UNSIGNED_BYTE&&(xe=o.RGB8UI),le===o.UNSIGNED_SHORT&&(xe=o.RGB16UI),le===o.UNSIGNED_INT&&(xe=o.RGB32UI),le===o.BYTE&&(xe=o.RGB8I),le===o.SHORT&&(xe=o.RGB16I),le===o.INT&&(xe=o.RGB32I)),A===o.RGBA_INTEGER&&(le===o.UNSIGNED_BYTE&&(xe=o.RGBA8UI),le===o.UNSIGNED_SHORT&&(xe=o.RGBA16UI),le===o.UNSIGNED_INT&&(xe=o.RGBA32UI),le===o.BYTE&&(xe=o.RGBA8I),le===o.SHORT&&(xe=o.RGBA16I),le===o.INT&&(xe=o.RGBA32I)),A===o.RGB&&(le===o.UNSIGNED_INT_5_9_9_9_REV&&(xe=o.RGB9_E5),le===o.UNSIGNED_INT_10F_11F_11F_REV&&(xe=o.R11F_G11F_B10F)),A===o.RGBA){const qe=Te?Uc:Lt.getTransfer(ye);le===o.FLOAT&&(xe=o.RGBA32F),le===o.HALF_FLOAT&&(xe=o.RGBA16F),le===o.UNSIGNED_BYTE&&(xe=qe===jt?o.SRGB8_ALPHA8:o.RGBA8),le===o.UNSIGNED_SHORT_4_4_4_4&&(xe=o.RGBA4),le===o.UNSIGNED_SHORT_5_5_5_1&&(xe=o.RGB5_A1)}return(xe===o.R16F||xe===o.R32F||xe===o.RG16F||xe===o.RG32F||xe===o.RGBA16F||xe===o.RGBA32F)&&t.get("EXT_color_buffer_float"),xe}function P(F,A){let le;return F?A===null||A===Rs||A===Bo?le=o.DEPTH24_STENCIL8:A===fa?le=o.DEPTH32F_STENCIL8:A===Fo&&(le=o.DEPTH24_STENCIL8,ut("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):A===null||A===Rs||A===Bo?le=o.DEPTH_COMPONENT24:A===fa?le=o.DEPTH_COMPONENT32F:A===Fo&&(le=o.DEPTH_COMPONENT16),le}function B(F,A){return S(F)===!0||F.isFramebufferTexture&&F.minFilter!==ai&&F.minFilter!==mi?Math.log2(Math.max(A.width,A.height))+1:F.mipmaps!==void 0&&F.mipmaps.length>0?F.mipmaps.length:F.isCompressedTexture&&Array.isArray(F.image)?A.mipmaps.length:1}function O(F){const A=F.target;A.removeEventListener("dispose",O),$(A),A.isVideoTexture&&x.delete(A)}function H(F){const A=F.target;A.removeEventListener("dispose",H),T(A)}function $(F){const A=s.get(F);if(A.__webglInit===void 0)return;const le=F.source,ye=y.get(le);if(ye){const Te=ye[A.__cacheKey];Te.usedTimes--,Te.usedTimes===0&&D(F),Object.keys(ye).length===0&&y.delete(le)}s.remove(F)}function D(F){const A=s.get(F);o.deleteTexture(A.__webglTexture);const le=F.source,ye=y.get(le);delete ye[A.__cacheKey],d.memory.textures--}function T(F){const A=s.get(F);if(F.depthTexture&&(F.depthTexture.dispose(),s.remove(F.depthTexture)),F.isWebGLCubeRenderTarget)for(let ye=0;ye<6;ye++){if(Array.isArray(A.__webglFramebuffer[ye]))for(let Te=0;Te<A.__webglFramebuffer[ye].length;Te++)o.deleteFramebuffer(A.__webglFramebuffer[ye][Te]);else o.deleteFramebuffer(A.__webglFramebuffer[ye]);A.__webglDepthbuffer&&o.deleteRenderbuffer(A.__webglDepthbuffer[ye])}else{if(Array.isArray(A.__webglFramebuffer))for(let ye=0;ye<A.__webglFramebuffer.length;ye++)o.deleteFramebuffer(A.__webglFramebuffer[ye]);else o.deleteFramebuffer(A.__webglFramebuffer);if(A.__webglDepthbuffer&&o.deleteRenderbuffer(A.__webglDepthbuffer),A.__webglMultisampledFramebuffer&&o.deleteFramebuffer(A.__webglMultisampledFramebuffer),A.__webglColorRenderbuffer)for(let ye=0;ye<A.__webglColorRenderbuffer.length;ye++)A.__webglColorRenderbuffer[ye]&&o.deleteRenderbuffer(A.__webglColorRenderbuffer[ye]);A.__webglDepthRenderbuffer&&o.deleteRenderbuffer(A.__webglDepthRenderbuffer)}const le=F.textures;for(let ye=0,Te=le.length;ye<Te;ye++){const xe=s.get(le[ye]);xe.__webglTexture&&(o.deleteTexture(xe.__webglTexture),d.memory.textures--),s.remove(le[ye])}s.remove(F)}let j=0;function Y(){j=0}function Q(){const F=j;return F>=l.maxTextures&&ut("WebGLTextures: Trying to use "+F+" texture units while this GPU supports only "+l.maxTextures),j+=1,F}function re(F){const A=[];return A.push(F.wrapS),A.push(F.wrapT),A.push(F.wrapR||0),A.push(F.magFilter),A.push(F.minFilter),A.push(F.anisotropy),A.push(F.internalFormat),A.push(F.format),A.push(F.type),A.push(F.generateMipmaps),A.push(F.premultiplyAlpha),A.push(F.flipY),A.push(F.unpackAlignment),A.push(F.colorSpace),A.join()}function ae(F,A){const le=s.get(F);if(F.isVideoTexture&&Xt(F),F.isRenderTargetTexture===!1&&F.isExternalTexture!==!0&&F.version>0&&le.__version!==F.version){const ye=F.image;if(ye===null)ut("WebGLRenderer: Texture marked for update but no image data found.");else if(ye.complete===!1)ut("WebGLRenderer: Texture marked for update but image is incomplete");else{K(le,F,A);return}}else F.isExternalTexture&&(le.__webglTexture=F.sourceTexture?F.sourceTexture:null);i.bindTexture(o.TEXTURE_2D,le.__webglTexture,o.TEXTURE0+A)}function I(F,A){const le=s.get(F);if(F.isRenderTargetTexture===!1&&F.version>0&&le.__version!==F.version){K(le,F,A);return}else F.isExternalTexture&&(le.__webglTexture=F.sourceTexture?F.sourceTexture:null);i.bindTexture(o.TEXTURE_2D_ARRAY,le.__webglTexture,o.TEXTURE0+A)}function G(F,A){const le=s.get(F);if(F.isRenderTargetTexture===!1&&F.version>0&&le.__version!==F.version){K(le,F,A);return}i.bindTexture(o.TEXTURE_3D,le.__webglTexture,o.TEXTURE0+A)}function U(F,A){const le=s.get(F);if(F.version>0&&le.__version!==F.version){ie(le,F,A);return}i.bindTexture(o.TEXTURE_CUBE_MAP,le.__webglTexture,o.TEXTURE0+A)}const V={[Kd]:o.REPEAT,[ua]:o.CLAMP_TO_EDGE,[Qd]:o.MIRRORED_REPEAT},J={[ai]:o.NEAREST,[gb]:o.NEAREST_MIPMAP_NEAREST,[ac]:o.NEAREST_MIPMAP_LINEAR,[mi]:o.LINEAR,[nd]:o.LINEAR_MIPMAP_NEAREST,[As]:o.LINEAR_MIPMAP_LINEAR},N={[bb]:o.NEVER,[Rb]:o.ALWAYS,[Sb]:o.LESS,[Kg]:o.LEQUAL,[Mb]:o.EQUAL,[Ab]:o.GEQUAL,[Eb]:o.GREATER,[Tb]:o.NOTEQUAL};function X(F,A){if(A.type===fa&&t.has("OES_texture_float_linear")===!1&&(A.magFilter===mi||A.magFilter===nd||A.magFilter===ac||A.magFilter===As||A.minFilter===mi||A.minFilter===nd||A.minFilter===ac||A.minFilter===As)&&ut("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),o.texParameteri(F,o.TEXTURE_WRAP_S,V[A.wrapS]),o.texParameteri(F,o.TEXTURE_WRAP_T,V[A.wrapT]),(F===o.TEXTURE_3D||F===o.TEXTURE_2D_ARRAY)&&o.texParameteri(F,o.TEXTURE_WRAP_R,V[A.wrapR]),o.texParameteri(F,o.TEXTURE_MAG_FILTER,J[A.magFilter]),o.texParameteri(F,o.TEXTURE_MIN_FILTER,J[A.minFilter]),A.compareFunction&&(o.texParameteri(F,o.TEXTURE_COMPARE_MODE,o.COMPARE_REF_TO_TEXTURE),o.texParameteri(F,o.TEXTURE_COMPARE_FUNC,N[A.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(A.magFilter===ai||A.minFilter!==ac&&A.minFilter!==As||A.type===fa&&t.has("OES_texture_float_linear")===!1)return;if(A.anisotropy>1||s.get(A).__currentAnisotropy){const le=t.get("EXT_texture_filter_anisotropic");o.texParameterf(F,le.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(A.anisotropy,l.getMaxAnisotropy())),s.get(A).__currentAnisotropy=A.anisotropy}}}function se(F,A){let le=!1;F.__webglInit===void 0&&(F.__webglInit=!0,A.addEventListener("dispose",O));const ye=A.source;let Te=y.get(ye);Te===void 0&&(Te={},y.set(ye,Te));const xe=re(A);if(xe!==F.__cacheKey){Te[xe]===void 0&&(Te[xe]={texture:o.createTexture(),usedTimes:0},d.memory.textures++,le=!0),Te[xe].usedTimes++;const qe=Te[F.__cacheKey];qe!==void 0&&(Te[F.__cacheKey].usedTimes--,qe.usedTimes===0&&D(A)),F.__cacheKey=xe,F.__webglTexture=Te[xe].texture}return le}function pe(F,A,le){return Math.floor(Math.floor(F/le)/A)}function Me(F,A,le,ye){const xe=F.updateRanges;if(xe.length===0)i.texSubImage2D(o.TEXTURE_2D,0,0,0,A.width,A.height,le,ye,A.data);else{xe.sort((Ae,Ce)=>Ae.start-Ce.start);let qe=0;for(let Ae=1;Ae<xe.length;Ae++){const Ce=xe[qe],We=xe[Ae],ke=Ce.start+Ce.count,Ie=pe(We.start,A.width,4),st=pe(Ce.start,A.width,4);We.start<=ke+1&&Ie===st&&pe(We.start+We.count-1,A.width,4)===Ie?Ce.count=Math.max(Ce.count,We.start+We.count-Ce.start):(++qe,xe[qe]=We)}xe.length=qe+1;const ze=o.getParameter(o.UNPACK_ROW_LENGTH),et=o.getParameter(o.UNPACK_SKIP_PIXELS),Xe=o.getParameter(o.UNPACK_SKIP_ROWS);o.pixelStorei(o.UNPACK_ROW_LENGTH,A.width);for(let Ae=0,Ce=xe.length;Ae<Ce;Ae++){const We=xe[Ae],ke=Math.floor(We.start/4),Ie=Math.ceil(We.count/4),st=ke%A.width,W=Math.floor(ke/A.width),Le=Ie,De=1;o.pixelStorei(o.UNPACK_SKIP_PIXELS,st),o.pixelStorei(o.UNPACK_SKIP_ROWS,W),i.texSubImage2D(o.TEXTURE_2D,0,st,W,Le,De,le,ye,A.data)}F.clearUpdateRanges(),o.pixelStorei(o.UNPACK_ROW_LENGTH,ze),o.pixelStorei(o.UNPACK_SKIP_PIXELS,et),o.pixelStorei(o.UNPACK_SKIP_ROWS,Xe)}}function K(F,A,le){let ye=o.TEXTURE_2D;(A.isDataArrayTexture||A.isCompressedArrayTexture)&&(ye=o.TEXTURE_2D_ARRAY),A.isData3DTexture&&(ye=o.TEXTURE_3D);const Te=se(F,A),xe=A.source;i.bindTexture(ye,F.__webglTexture,o.TEXTURE0+le);const qe=s.get(xe);if(xe.version!==qe.__version||Te===!0){i.activeTexture(o.TEXTURE0+le);const ze=Lt.getPrimaries(Lt.workingColorSpace),et=A.colorSpace===Wa?null:Lt.getPrimaries(A.colorSpace),Xe=A.colorSpace===Wa||ze===et?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,A.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,A.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,A.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,Xe);let Ae=R(A.image,!1,l.maxTextureSize);Ae=Ze(A,Ae);const Ce=c.convert(A.format,A.colorSpace),We=c.convert(A.type);let ke=L(A.internalFormat,Ce,We,A.colorSpace,A.isVideoTexture);X(ye,A);let Ie;const st=A.mipmaps,W=A.isVideoTexture!==!0,Le=qe.__version===void 0||Te===!0,De=xe.dataReady,Ne=B(A,Ae);if(A.isDepthTexture)ke=P(A.format===Go,A.type),Le&&(W?i.texStorage2D(o.TEXTURE_2D,1,ke,Ae.width,Ae.height):i.texImage2D(o.TEXTURE_2D,0,ke,Ae.width,Ae.height,0,Ce,We,null));else if(A.isDataTexture)if(st.length>0){W&&Le&&i.texStorage2D(o.TEXTURE_2D,Ne,ke,st[0].width,st[0].height);for(let Re=0,Se=st.length;Re<Se;Re++)Ie=st[Re],W?De&&i.texSubImage2D(o.TEXTURE_2D,Re,0,0,Ie.width,Ie.height,Ce,We,Ie.data):i.texImage2D(o.TEXTURE_2D,Re,ke,Ie.width,Ie.height,0,Ce,We,Ie.data);A.generateMipmaps=!1}else W?(Le&&i.texStorage2D(o.TEXTURE_2D,Ne,ke,Ae.width,Ae.height),De&&Me(A,Ae,Ce,We)):i.texImage2D(o.TEXTURE_2D,0,ke,Ae.width,Ae.height,0,Ce,We,Ae.data);else if(A.isCompressedTexture)if(A.isCompressedArrayTexture){W&&Le&&i.texStorage3D(o.TEXTURE_2D_ARRAY,Ne,ke,st[0].width,st[0].height,Ae.depth);for(let Re=0,Se=st.length;Re<Se;Re++)if(Ie=st[Re],A.format!==Ti)if(Ce!==null)if(W){if(De)if(A.layerUpdates.size>0){const Be=lg(Ie.width,Ie.height,A.format,A.type);for(const rt of A.layerUpdates){const Ht=Ie.data.subarray(rt*Be/Ie.data.BYTES_PER_ELEMENT,(rt+1)*Be/Ie.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,Re,0,0,rt,Ie.width,Ie.height,1,Ce,Ht)}A.clearLayerUpdates()}else i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,Re,0,0,0,Ie.width,Ie.height,Ae.depth,Ce,Ie.data)}else i.compressedTexImage3D(o.TEXTURE_2D_ARRAY,Re,ke,Ie.width,Ie.height,Ae.depth,0,Ie.data,0,0);else ut("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else W?De&&i.texSubImage3D(o.TEXTURE_2D_ARRAY,Re,0,0,0,Ie.width,Ie.height,Ae.depth,Ce,We,Ie.data):i.texImage3D(o.TEXTURE_2D_ARRAY,Re,ke,Ie.width,Ie.height,Ae.depth,0,Ce,We,Ie.data)}else{W&&Le&&i.texStorage2D(o.TEXTURE_2D,Ne,ke,st[0].width,st[0].height);for(let Re=0,Se=st.length;Re<Se;Re++)Ie=st[Re],A.format!==Ti?Ce!==null?W?De&&i.compressedTexSubImage2D(o.TEXTURE_2D,Re,0,0,Ie.width,Ie.height,Ce,Ie.data):i.compressedTexImage2D(o.TEXTURE_2D,Re,ke,Ie.width,Ie.height,0,Ie.data):ut("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):W?De&&i.texSubImage2D(o.TEXTURE_2D,Re,0,0,Ie.width,Ie.height,Ce,We,Ie.data):i.texImage2D(o.TEXTURE_2D,Re,ke,Ie.width,Ie.height,0,Ce,We,Ie.data)}else if(A.isDataArrayTexture)if(W){if(Le&&i.texStorage3D(o.TEXTURE_2D_ARRAY,Ne,ke,Ae.width,Ae.height,Ae.depth),De)if(A.layerUpdates.size>0){const Re=lg(Ae.width,Ae.height,A.format,A.type);for(const Se of A.layerUpdates){const Be=Ae.data.subarray(Se*Re/Ae.data.BYTES_PER_ELEMENT,(Se+1)*Re/Ae.data.BYTES_PER_ELEMENT);i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,Se,Ae.width,Ae.height,1,Ce,We,Be)}A.clearLayerUpdates()}else i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,0,Ae.width,Ae.height,Ae.depth,Ce,We,Ae.data)}else i.texImage3D(o.TEXTURE_2D_ARRAY,0,ke,Ae.width,Ae.height,Ae.depth,0,Ce,We,Ae.data);else if(A.isData3DTexture)W?(Le&&i.texStorage3D(o.TEXTURE_3D,Ne,ke,Ae.width,Ae.height,Ae.depth),De&&i.texSubImage3D(o.TEXTURE_3D,0,0,0,0,Ae.width,Ae.height,Ae.depth,Ce,We,Ae.data)):i.texImage3D(o.TEXTURE_3D,0,ke,Ae.width,Ae.height,Ae.depth,0,Ce,We,Ae.data);else if(A.isFramebufferTexture){if(Le)if(W)i.texStorage2D(o.TEXTURE_2D,Ne,ke,Ae.width,Ae.height);else{let Re=Ae.width,Se=Ae.height;for(let Be=0;Be<Ne;Be++)i.texImage2D(o.TEXTURE_2D,Be,ke,Re,Se,0,Ce,We,null),Re>>=1,Se>>=1}}else if(st.length>0){if(W&&Le){const Re=ot(st[0]);i.texStorage2D(o.TEXTURE_2D,Ne,ke,Re.width,Re.height)}for(let Re=0,Se=st.length;Re<Se;Re++)Ie=st[Re],W?De&&i.texSubImage2D(o.TEXTURE_2D,Re,0,0,Ce,We,Ie):i.texImage2D(o.TEXTURE_2D,Re,ke,Ce,We,Ie);A.generateMipmaps=!1}else if(W){if(Le){const Re=ot(Ae);i.texStorage2D(o.TEXTURE_2D,Ne,ke,Re.width,Re.height)}De&&i.texSubImage2D(o.TEXTURE_2D,0,0,0,Ce,We,Ae)}else i.texImage2D(o.TEXTURE_2D,0,ke,Ce,We,Ae);S(A)&&_(ye),qe.__version=xe.version,A.onUpdate&&A.onUpdate(A)}F.__version=A.version}function ie(F,A,le){if(A.image.length!==6)return;const ye=se(F,A),Te=A.source;i.bindTexture(o.TEXTURE_CUBE_MAP,F.__webglTexture,o.TEXTURE0+le);const xe=s.get(Te);if(Te.version!==xe.__version||ye===!0){i.activeTexture(o.TEXTURE0+le);const qe=Lt.getPrimaries(Lt.workingColorSpace),ze=A.colorSpace===Wa?null:Lt.getPrimaries(A.colorSpace),et=A.colorSpace===Wa||qe===ze?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,A.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,A.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,A.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,et);const Xe=A.isCompressedTexture||A.image[0].isCompressedTexture,Ae=A.image[0]&&A.image[0].isDataTexture,Ce=[];for(let Se=0;Se<6;Se++)!Xe&&!Ae?Ce[Se]=R(A.image[Se],!0,l.maxCubemapSize):Ce[Se]=Ae?A.image[Se].image:A.image[Se],Ce[Se]=Ze(A,Ce[Se]);const We=Ce[0],ke=c.convert(A.format,A.colorSpace),Ie=c.convert(A.type),st=L(A.internalFormat,ke,Ie,A.colorSpace),W=A.isVideoTexture!==!0,Le=xe.__version===void 0||ye===!0,De=Te.dataReady;let Ne=B(A,We);X(o.TEXTURE_CUBE_MAP,A);let Re;if(Xe){W&&Le&&i.texStorage2D(o.TEXTURE_CUBE_MAP,Ne,st,We.width,We.height);for(let Se=0;Se<6;Se++){Re=Ce[Se].mipmaps;for(let Be=0;Be<Re.length;Be++){const rt=Re[Be];A.format!==Ti?ke!==null?W?De&&i.compressedTexSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Se,Be,0,0,rt.width,rt.height,ke,rt.data):i.compressedTexImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Se,Be,st,rt.width,rt.height,0,rt.data):ut("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):W?De&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Se,Be,0,0,rt.width,rt.height,ke,Ie,rt.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Se,Be,st,rt.width,rt.height,0,ke,Ie,rt.data)}}}else{if(Re=A.mipmaps,W&&Le){Re.length>0&&Ne++;const Se=ot(Ce[0]);i.texStorage2D(o.TEXTURE_CUBE_MAP,Ne,st,Se.width,Se.height)}for(let Se=0;Se<6;Se++)if(Ae){W?De&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Se,0,0,0,Ce[Se].width,Ce[Se].height,ke,Ie,Ce[Se].data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Se,0,st,Ce[Se].width,Ce[Se].height,0,ke,Ie,Ce[Se].data);for(let Be=0;Be<Re.length;Be++){const Ht=Re[Be].image[Se].image;W?De&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Se,Be+1,0,0,Ht.width,Ht.height,ke,Ie,Ht.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Se,Be+1,st,Ht.width,Ht.height,0,ke,Ie,Ht.data)}}else{W?De&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Se,0,0,0,ke,Ie,Ce[Se]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Se,0,st,ke,Ie,Ce[Se]);for(let Be=0;Be<Re.length;Be++){const rt=Re[Be];W?De&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Se,Be+1,0,0,ke,Ie,rt.image[Se]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Se,Be+1,st,ke,Ie,rt.image[Se])}}}S(A)&&_(o.TEXTURE_CUBE_MAP),xe.__version=Te.version,A.onUpdate&&A.onUpdate(A)}F.__version=A.version}function _e(F,A,le,ye,Te,xe){const qe=c.convert(le.format,le.colorSpace),ze=c.convert(le.type),et=L(le.internalFormat,qe,ze,le.colorSpace),Xe=s.get(A),Ae=s.get(le);if(Ae.__renderTarget=A,!Xe.__hasExternalTextures){const Ce=Math.max(1,A.width>>xe),We=Math.max(1,A.height>>xe);Te===o.TEXTURE_3D||Te===o.TEXTURE_2D_ARRAY?i.texImage3D(Te,xe,et,Ce,We,A.depth,0,qe,ze,null):i.texImage2D(Te,xe,et,Ce,We,0,qe,ze,null)}i.bindFramebuffer(o.FRAMEBUFFER,F),Ve(A)?h.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,ye,Te,Ae.__webglTexture,0,It(A)):(Te===o.TEXTURE_2D||Te>=o.TEXTURE_CUBE_MAP_POSITIVE_X&&Te<=o.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&o.framebufferTexture2D(o.FRAMEBUFFER,ye,Te,Ae.__webglTexture,xe),i.bindFramebuffer(o.FRAMEBUFFER,null)}function Ee(F,A,le){if(o.bindRenderbuffer(o.RENDERBUFFER,F),A.depthBuffer){const ye=A.depthTexture,Te=ye&&ye.isDepthTexture?ye.type:null,xe=P(A.stencilBuffer,Te),qe=A.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,ze=It(A);Ve(A)?h.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,ze,xe,A.width,A.height):le?o.renderbufferStorageMultisample(o.RENDERBUFFER,ze,xe,A.width,A.height):o.renderbufferStorage(o.RENDERBUFFER,xe,A.width,A.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,qe,o.RENDERBUFFER,F)}else{const ye=A.textures;for(let Te=0;Te<ye.length;Te++){const xe=ye[Te],qe=c.convert(xe.format,xe.colorSpace),ze=c.convert(xe.type),et=L(xe.internalFormat,qe,ze,xe.colorSpace),Xe=It(A);le&&Ve(A)===!1?o.renderbufferStorageMultisample(o.RENDERBUFFER,Xe,et,A.width,A.height):Ve(A)?h.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,Xe,et,A.width,A.height):o.renderbufferStorage(o.RENDERBUFFER,et,A.width,A.height)}}o.bindRenderbuffer(o.RENDERBUFFER,null)}function Ue(F,A){if(A&&A.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(i.bindFramebuffer(o.FRAMEBUFFER,F),!(A.depthTexture&&A.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const ye=s.get(A.depthTexture);ye.__renderTarget=A,(!ye.__webglTexture||A.depthTexture.image.width!==A.width||A.depthTexture.image.height!==A.height)&&(A.depthTexture.image.width=A.width,A.depthTexture.image.height=A.height,A.depthTexture.needsUpdate=!0),ae(A.depthTexture,0);const Te=ye.__webglTexture,xe=It(A);if(A.depthTexture.format===Ho)Ve(A)?h.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,Te,0,xe):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,Te,0);else if(A.depthTexture.format===Go)Ve(A)?h.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,Te,0,xe):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,Te,0);else throw new Error("Unknown depthTexture format")}function $e(F){const A=s.get(F),le=F.isWebGLCubeRenderTarget===!0;if(A.__boundDepthTexture!==F.depthTexture){const ye=F.depthTexture;if(A.__depthDisposeCallback&&A.__depthDisposeCallback(),ye){const Te=()=>{delete A.__boundDepthTexture,delete A.__depthDisposeCallback,ye.removeEventListener("dispose",Te)};ye.addEventListener("dispose",Te),A.__depthDisposeCallback=Te}A.__boundDepthTexture=ye}if(F.depthTexture&&!A.__autoAllocateDepthBuffer){if(le)throw new Error("target.depthTexture not supported in Cube render targets");const ye=F.texture.mipmaps;ye&&ye.length>0?Ue(A.__webglFramebuffer[0],F):Ue(A.__webglFramebuffer,F)}else if(le){A.__webglDepthbuffer=[];for(let ye=0;ye<6;ye++)if(i.bindFramebuffer(o.FRAMEBUFFER,A.__webglFramebuffer[ye]),A.__webglDepthbuffer[ye]===void 0)A.__webglDepthbuffer[ye]=o.createRenderbuffer(),Ee(A.__webglDepthbuffer[ye],F,!1);else{const Te=F.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,xe=A.__webglDepthbuffer[ye];o.bindRenderbuffer(o.RENDERBUFFER,xe),o.framebufferRenderbuffer(o.FRAMEBUFFER,Te,o.RENDERBUFFER,xe)}}else{const ye=F.texture.mipmaps;if(ye&&ye.length>0?i.bindFramebuffer(o.FRAMEBUFFER,A.__webglFramebuffer[0]):i.bindFramebuffer(o.FRAMEBUFFER,A.__webglFramebuffer),A.__webglDepthbuffer===void 0)A.__webglDepthbuffer=o.createRenderbuffer(),Ee(A.__webglDepthbuffer,F,!1);else{const Te=F.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,xe=A.__webglDepthbuffer;o.bindRenderbuffer(o.RENDERBUFFER,xe),o.framebufferRenderbuffer(o.FRAMEBUFFER,Te,o.RENDERBUFFER,xe)}}i.bindFramebuffer(o.FRAMEBUFFER,null)}function yt(F,A,le){const ye=s.get(F);A!==void 0&&_e(ye.__webglFramebuffer,F,F.texture,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,0),le!==void 0&&$e(F)}function Ke(F){const A=F.texture,le=s.get(F),ye=s.get(A);F.addEventListener("dispose",H);const Te=F.textures,xe=F.isWebGLCubeRenderTarget===!0,qe=Te.length>1;if(qe||(ye.__webglTexture===void 0&&(ye.__webglTexture=o.createTexture()),ye.__version=A.version,d.memory.textures++),xe){le.__webglFramebuffer=[];for(let ze=0;ze<6;ze++)if(A.mipmaps&&A.mipmaps.length>0){le.__webglFramebuffer[ze]=[];for(let et=0;et<A.mipmaps.length;et++)le.__webglFramebuffer[ze][et]=o.createFramebuffer()}else le.__webglFramebuffer[ze]=o.createFramebuffer()}else{if(A.mipmaps&&A.mipmaps.length>0){le.__webglFramebuffer=[];for(let ze=0;ze<A.mipmaps.length;ze++)le.__webglFramebuffer[ze]=o.createFramebuffer()}else le.__webglFramebuffer=o.createFramebuffer();if(qe)for(let ze=0,et=Te.length;ze<et;ze++){const Xe=s.get(Te[ze]);Xe.__webglTexture===void 0&&(Xe.__webglTexture=o.createTexture(),d.memory.textures++)}if(F.samples>0&&Ve(F)===!1){le.__webglMultisampledFramebuffer=o.createFramebuffer(),le.__webglColorRenderbuffer=[],i.bindFramebuffer(o.FRAMEBUFFER,le.__webglMultisampledFramebuffer);for(let ze=0;ze<Te.length;ze++){const et=Te[ze];le.__webglColorRenderbuffer[ze]=o.createRenderbuffer(),o.bindRenderbuffer(o.RENDERBUFFER,le.__webglColorRenderbuffer[ze]);const Xe=c.convert(et.format,et.colorSpace),Ae=c.convert(et.type),Ce=L(et.internalFormat,Xe,Ae,et.colorSpace,F.isXRRenderTarget===!0),We=It(F);o.renderbufferStorageMultisample(o.RENDERBUFFER,We,Ce,F.width,F.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+ze,o.RENDERBUFFER,le.__webglColorRenderbuffer[ze])}o.bindRenderbuffer(o.RENDERBUFFER,null),F.depthBuffer&&(le.__webglDepthRenderbuffer=o.createRenderbuffer(),Ee(le.__webglDepthRenderbuffer,F,!0)),i.bindFramebuffer(o.FRAMEBUFFER,null)}}if(xe){i.bindTexture(o.TEXTURE_CUBE_MAP,ye.__webglTexture),X(o.TEXTURE_CUBE_MAP,A);for(let ze=0;ze<6;ze++)if(A.mipmaps&&A.mipmaps.length>0)for(let et=0;et<A.mipmaps.length;et++)_e(le.__webglFramebuffer[ze][et],F,A,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+ze,et);else _e(le.__webglFramebuffer[ze],F,A,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+ze,0);S(A)&&_(o.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(qe){for(let ze=0,et=Te.length;ze<et;ze++){const Xe=Te[ze],Ae=s.get(Xe);let Ce=o.TEXTURE_2D;(F.isWebGL3DRenderTarget||F.isWebGLArrayRenderTarget)&&(Ce=F.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),i.bindTexture(Ce,Ae.__webglTexture),X(Ce,Xe),_e(le.__webglFramebuffer,F,Xe,o.COLOR_ATTACHMENT0+ze,Ce,0),S(Xe)&&_(Ce)}i.unbindTexture()}else{let ze=o.TEXTURE_2D;if((F.isWebGL3DRenderTarget||F.isWebGLArrayRenderTarget)&&(ze=F.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),i.bindTexture(ze,ye.__webglTexture),X(ze,A),A.mipmaps&&A.mipmaps.length>0)for(let et=0;et<A.mipmaps.length;et++)_e(le.__webglFramebuffer[et],F,A,o.COLOR_ATTACHMENT0,ze,et);else _e(le.__webglFramebuffer,F,A,o.COLOR_ATTACHMENT0,ze,0);S(A)&&_(ze),i.unbindTexture()}F.depthBuffer&&$e(F)}function ct(F){const A=F.textures;for(let le=0,ye=A.length;le<ye;le++){const Te=A[le];if(S(Te)){const xe=z(F),qe=s.get(Te).__webglTexture;i.bindTexture(xe,qe),_(xe),i.unbindTexture()}}}const q=[],mt=[];function gt(F){if(F.samples>0){if(Ve(F)===!1){const A=F.textures,le=F.width,ye=F.height;let Te=o.COLOR_BUFFER_BIT;const xe=F.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,qe=s.get(F),ze=A.length>1;if(ze)for(let Xe=0;Xe<A.length;Xe++)i.bindFramebuffer(o.FRAMEBUFFER,qe.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Xe,o.RENDERBUFFER,null),i.bindFramebuffer(o.FRAMEBUFFER,qe.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+Xe,o.TEXTURE_2D,null,0);i.bindFramebuffer(o.READ_FRAMEBUFFER,qe.__webglMultisampledFramebuffer);const et=F.texture.mipmaps;et&&et.length>0?i.bindFramebuffer(o.DRAW_FRAMEBUFFER,qe.__webglFramebuffer[0]):i.bindFramebuffer(o.DRAW_FRAMEBUFFER,qe.__webglFramebuffer);for(let Xe=0;Xe<A.length;Xe++){if(F.resolveDepthBuffer&&(F.depthBuffer&&(Te|=o.DEPTH_BUFFER_BIT),F.stencilBuffer&&F.resolveStencilBuffer&&(Te|=o.STENCIL_BUFFER_BIT)),ze){o.framebufferRenderbuffer(o.READ_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.RENDERBUFFER,qe.__webglColorRenderbuffer[Xe]);const Ae=s.get(A[Xe]).__webglTexture;o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,Ae,0)}o.blitFramebuffer(0,0,le,ye,0,0,le,ye,Te,o.NEAREST),m===!0&&(q.length=0,mt.length=0,q.push(o.COLOR_ATTACHMENT0+Xe),F.depthBuffer&&F.resolveDepthBuffer===!1&&(q.push(xe),mt.push(xe),o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,mt)),o.invalidateFramebuffer(o.READ_FRAMEBUFFER,q))}if(i.bindFramebuffer(o.READ_FRAMEBUFFER,null),i.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),ze)for(let Xe=0;Xe<A.length;Xe++){i.bindFramebuffer(o.FRAMEBUFFER,qe.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Xe,o.RENDERBUFFER,qe.__webglColorRenderbuffer[Xe]);const Ae=s.get(A[Xe]).__webglTexture;i.bindFramebuffer(o.FRAMEBUFFER,qe.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+Xe,o.TEXTURE_2D,Ae,0)}i.bindFramebuffer(o.DRAW_FRAMEBUFFER,qe.__webglMultisampledFramebuffer)}else if(F.depthBuffer&&F.resolveDepthBuffer===!1&&m){const A=F.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT;o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,[A])}}}function It(F){return Math.min(l.maxSamples,F.samples)}function Ve(F){const A=s.get(F);return F.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&A.__useRenderToTexture!==!1}function Xt(F){const A=d.render.frame;x.get(F)!==A&&(x.set(F,A),F.update())}function Ze(F,A){const le=F.colorSpace,ye=F.format,Te=F.type;return F.isCompressedTexture===!0||F.isVideoTexture===!0||le!==Ar&&le!==Wa&&(Lt.getTransfer(le)===jt?(ye!==Ti||Te!==Oi)&&ut("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):rn("WebGLTextures: Unsupported texture color space:",le)),A}function ot(F){return typeof HTMLImageElement<"u"&&F instanceof HTMLImageElement?(p.width=F.naturalWidth||F.width,p.height=F.naturalHeight||F.height):typeof VideoFrame<"u"&&F instanceof VideoFrame?(p.width=F.displayWidth,p.height=F.displayHeight):(p.width=F.width,p.height=F.height),p}this.allocateTextureUnit=Q,this.resetTextureUnits=Y,this.setTexture2D=ae,this.setTexture2DArray=I,this.setTexture3D=G,this.setTextureCube=U,this.rebindTextures=yt,this.setupRenderTarget=Ke,this.updateRenderTargetMipmap=ct,this.updateMultisampleRenderTarget=gt,this.setupDepthRenderbuffer=$e,this.setupFrameBufferTexture=_e,this.useMultisampledRTT=Ve}function VE(o,t){function i(s,l=Wa){let c;const d=Lt.getTransfer(l);if(s===Oi)return o.UNSIGNED_BYTE;if(s===Lh)return o.UNSIGNED_SHORT_4_4_4_4;if(s===Oh)return o.UNSIGNED_SHORT_5_5_5_1;if(s===jg)return o.UNSIGNED_INT_5_9_9_9_REV;if(s===Xg)return o.UNSIGNED_INT_10F_11F_11F_REV;if(s===Vg)return o.BYTE;if(s===kg)return o.SHORT;if(s===Fo)return o.UNSIGNED_SHORT;if(s===Uh)return o.INT;if(s===Rs)return o.UNSIGNED_INT;if(s===fa)return o.FLOAT;if(s===Dr)return o.HALF_FLOAT;if(s===qg)return o.ALPHA;if(s===Wg)return o.RGB;if(s===Ti)return o.RGBA;if(s===Ho)return o.DEPTH_COMPONENT;if(s===Go)return o.DEPTH_STENCIL;if(s===Yg)return o.RED;if(s===zh)return o.RED_INTEGER;if(s===Ph)return o.RG;if(s===Ih)return o.RG_INTEGER;if(s===Fh)return o.RGBA_INTEGER;if(s===Rc||s===Cc||s===wc||s===Dc)if(d===jt)if(c=t.get("WEBGL_compressed_texture_s3tc_srgb"),c!==null){if(s===Rc)return c.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===Cc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===wc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===Dc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(c=t.get("WEBGL_compressed_texture_s3tc"),c!==null){if(s===Rc)return c.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===Cc)return c.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===wc)return c.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===Dc)return c.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===Jd||s===$d||s===eh||s===th)if(c=t.get("WEBGL_compressed_texture_pvrtc"),c!==null){if(s===Jd)return c.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===$d)return c.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===eh)return c.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===th)return c.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===nh||s===ih||s===ah)if(c=t.get("WEBGL_compressed_texture_etc"),c!==null){if(s===nh||s===ih)return d===jt?c.COMPRESSED_SRGB8_ETC2:c.COMPRESSED_RGB8_ETC2;if(s===ah)return d===jt?c.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:c.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===sh||s===rh||s===oh||s===lh||s===ch||s===uh||s===fh||s===dh||s===hh||s===ph||s===mh||s===xh||s===gh||s===_h)if(c=t.get("WEBGL_compressed_texture_astc"),c!==null){if(s===sh)return d===jt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:c.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===rh)return d===jt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:c.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===oh)return d===jt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:c.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===lh)return d===jt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:c.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===ch)return d===jt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:c.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===uh)return d===jt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:c.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===fh)return d===jt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:c.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===dh)return d===jt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:c.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===hh)return d===jt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:c.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===ph)return d===jt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:c.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===mh)return d===jt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:c.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===xh)return d===jt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:c.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===gh)return d===jt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:c.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===_h)return d===jt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:c.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===vh||s===yh||s===bh)if(c=t.get("EXT_texture_compression_bptc"),c!==null){if(s===vh)return d===jt?c.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:c.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===yh)return c.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===bh)return c.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===Sh||s===Mh||s===Eh||s===Th)if(c=t.get("EXT_texture_compression_rgtc"),c!==null){if(s===Sh)return c.COMPRESSED_RED_RGTC1_EXT;if(s===Mh)return c.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===Eh)return c.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===Th)return c.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===Bo?o.UNSIGNED_INT_24_8:o[s]!==void 0?o[s]:null}return{convert:i}}const kE=`
void main() {
